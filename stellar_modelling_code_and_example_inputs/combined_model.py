...
Original file is located at
    https://colab.research.google.com/drive/1BcYVeVe388x7XwNn6SvV3xJNi3BltPkv
"""
...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    grid_path = "/content/grids/BaSTI_iso2018.hdf5"
    define_io["gridfile"] = grid_path

    # Where to store the output of the BASTA run
    define_io["outputpath"] = os.path.join("WASP-17_combined_model_output")
    ...
    define_io["asciifile"] = "/content/WASP-17_combined_model_input.ascii"
    define_io["params"] = (
        "starid",
        "lon",
        "lat",
    ...
    #define_fit["fitparams"] = ("parallax", "Teff", "FeH", "rho")
    define_fit["fitparams"] = ("Teff", "FeH", "rho")
    ...
    define_fit["priors"] = {"Teff": {"sigmacut": "3"}, "FeH": {"sigmacut": "3"}, "rho": {"sigmacut": "3"}}
  ...
  ###define_fit["filters"] = ("Mk_2MASS")
    ...
    #define_output["outparams"] = ("distance", "Teff", "FeH", "rho", "radPhot", "massfin", "age")
    define_output["outparams"] = ("Teff", "FeH", "rho", "radPhot", "massfin", "age")
    ...
    define_output["outputfile"] = "WASP-17_combined_model_results.ascii"
