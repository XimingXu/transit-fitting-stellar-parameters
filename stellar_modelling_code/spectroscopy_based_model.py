...
def define_input(define_io, define_fit, define_output, define_plots, define_intpol):
    ...
    define_io["outputpath"] = os.path.join("WASP-17 spectroscopy-based model output")
    ...
    define_io["asciifile"] = "/content/WASP-17 (spectroscopy-based model).ascii"
    define_io["params"] = (
        "starid",
        "lon",
        "lat",
  ...
  ###define_fit["filters"] = ("Mk_2MASS")
    ...
    define_output["outputfile"] = "WASP-17 (spectroscopy-based model) results.ascii"
